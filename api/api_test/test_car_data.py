...
def test_make_car(player: str,text: str):
    ...
    with open('api_test/test_img.bin', 'rb') as file:
    ...
    car_img_binary = base64.b64encode(car_img_binary).decode("utf-8")
    return {"binary_car_img": car_img_binary,"name": name,"luk": luk,"text_car_status": text_car_status}
